...
# How to run ?
- First: pull the code to your computer and edit the ROOT in file Image-to-Image_Retrieval.py into your folder's path, which links to the folder having features' classes you want to queryge-To-Image-Retrieval
...
# How to run ?
- Firstly: pull the code to your computer and edit the ROOT in file Image-to-Image_Retrieval.py into your folder's path, which links to the folder having features' classes you want to retrieve.
- Secondly: edit img_path in row 93 and row 166 in file .py into your query image's path and run the program.
- Notice: the code from the line 19 to line 101 is for the first solution (retrieval bases on pixels' similarity) and the left code is for the second solution (retrieval bases on Feature extraction using Color Histogram)
